...
param.K = 3;
[resultmean.pred{1,1},resultmean.actCls{1,1},resultmean.acc{1,1}]=tanalyze(training1,test1,1,param,1);
...
param.classifier='knn';fprintf(param.classifier);
param.K = 2;
[resultmean.pred{2,1},resultmean.actCls{2,1},resultmean.acc{2,1}]=tanalyze(training2,test2,1,param,2);
save('results.mat','resultmean');
% % 
% subject 3
load UCIbegin3;
...
param.classifier='knn';fprintf(param.classifier);
param.K = 4;
[resultmean.pred{3,1},resultmean.actCls{3,1},resultmean.acc{3,1}]=tanalyze(training3,test3,1,param,3);
save('results.mat','resultmean');
...
[resultmean.pred{4,1},resultmean.actCls{4,1},resultmean.acc{4,1}]=tanalyze(training4,test4,1,param,4);
save('results.mat','resultmean');